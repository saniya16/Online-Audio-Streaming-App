<?php
mysqli_connect('localhost','SUR','','sur');
// mysqli_select_db("sur") or die("Could not find the song.");
$output='';
//collect
...
$query=mysqli_query("SELECT * from song WHERE SongName LIKE '%$searchq%' OR Artist LIKE '%$searchq%' OR Genre LIKE '%$searchq%'");
...
$output.='<div> '.$songname.''.$singer.''.$genre.'</div>';
}
...
<body>
  ...
  <nav id="mainNav" class="navbar navbar-expand-md navbar-dark py-0">
    ...
    <form class="d-flex" action="playlist1.php" method="POST">
      <input class="form-control me-2" name="search" type="search" placeholder="Song, Artist, Genre" aria-label="Search">
...
<!-- <div class="col-lg-3 mb-4">
<div class="card bg-dark" style=" height: 14rem; width: 224px;">
  <img src="https://static.wikia.nocookie.net/myat40/images/5/5a/Nicky_Jam_El_Perdon_cover.jpg/revision/latest/scale-to-width-down/340?cb=20151025010833" class="card-img-top" alt="...">
  <div class="card-body">
  <ul class="list-group list-group-flush" type="none">
